...
#define PS3_BUTTON_SELECT            6

#define PS3_BUTTON_STICK_LEFT        1
#define PS3_BUTTON_STICK_RIGHT       2
#define PS3_BUTTON_START             7
...
#define PS3_AXIS_STICK_RIGHT_LEFTWARDS   3
#define PS3_AXIS_STICK_RIGHT_UPWARDS     4
...
#define PS3_AXIS_BUTTON_REAR_LEFT_2      2
#define PS3_AXIS_BUTTON_REAR_RIGHT_2     5
#define PS3_AXIS_BUTTON_REAR_LEFT_1      4
#define PS3_AXIS_BUTTON_REAR_RIGHT_1     5

#define PS3_AXIS_BUTTON_ACTION_TRIANGLE  3
#define PS3_AXIS_BUTTON_ACTION_CIRCLE    1
#define PS3_AXIS_BUTTON_ACTION_CROSS     0
#define PS3_AXIS_BUTTON_ACTION_SQUARE    2
